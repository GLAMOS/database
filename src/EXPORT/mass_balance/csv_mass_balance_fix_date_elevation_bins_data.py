...
statement = "SELECT * FROM mass_balance.csv_mass_balance_fix_date_elevation_bins_data;"
...
filename = "mass_balance_fix_date_elevation_bins.csv"
...
with open(filename, 'w', encoding='utf-8') as the_file:
    ...
    the_file.write("\n")
    the_file.write("GLACIOLOGICAL MASS BALANCE, ELEVATION BINS (HYDROLOGICAL YEAR)\n")
    the_file.write("\n")
