...
if __name__ == "__main__":
    ...
    title = parser.get('massbalance_observation_elevationbins', 'title')
    citation = parser.get('massbalance_observation_elevationbins', 'citation')

    filename = parser.get('massbalance_observation_elevationbins', 'filename')
    statement = parser.get('massbalance_observation_elevationbins', 'statement')
