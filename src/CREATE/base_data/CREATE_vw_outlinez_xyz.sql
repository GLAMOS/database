-- View: base_data.vw_outlinez_xyz

-- DROP VIEW base_data.vw_outlinez_xyz;

CREATE OR REPLACE VIEW base_data.vw_outlinez_xyz AS
...
ALTER TABLE base_data.vw_outlinez_xyz
    OWNER TO gladmin;

GRANT INSERT, SELECT, UPDATE, DELETE ON TABLE base_data.vw_outlinez_xyz TO gldirw;
GRANT ALL ON TABLE base_data.vw_outlinez_xyz TO gladmin;
GRANT INSERT, SELECT, UPDATE, DELETE ON TABLE base_data.vw_outlinez_xyz TO glrw;
GRANT SELECT ON TABLE base_data.vw_outlinez_xyz TO glro;
GRANT SELECT ON TABLE base_data.vw_outlinez_xyz TO gldiro;