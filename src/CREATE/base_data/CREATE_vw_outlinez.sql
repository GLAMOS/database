-- View: base_data.vw_outlinez

-- DROP VIEW base_data.vw_outlinez;

CREATE OR REPLACE VIEW base_data.vw_outlinez AS
...
ALTER TABLE base_data.vw_outlinez
    OWNER TO gladmin;

GRANT INSERT, SELECT, UPDATE, DELETE ON TABLE base_data.vw_outlinez TO gldirw;
GRANT ALL ON TABLE base_data.vw_outlinez TO gladmin;
GRANT INSERT, SELECT, UPDATE, DELETE ON TABLE base_data.vw_outlinez TO glrw;
GRANT SELECT ON TABLE base_data.vw_outlinez TO glro;
GRANT SELECT ON TABLE base_data.vw_outlinez TO gldiro;
