CREATE OR REPLACE VIEW mass_balance.vw_mass_balance_fix_date_cumulative AS
	SELECT
		g.pk                        AS pk_glacier,	
		g.pk_vaw                    AS pk_vaw,
		g.pk_sgi                    AS pk_sgi,
...
ALTER TABLE mass_balance.vw_mass_balance_fix_date_cumulative
    OWNER TO gladmin;

GRANT ALL ON TABLE mass_balance.vw_mass_balance_fix_date_cumulative TO gladmin;