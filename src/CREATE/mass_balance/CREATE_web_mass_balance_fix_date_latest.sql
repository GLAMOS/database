CREATE OR REPLACE VIEW mass_balance.web_mass_balance_fix_date_latest AS
	SELECT 
...
ALTER TABLE mass_balance.web_mass_balance_fix_date_latest
    OWNER TO gladmin;

GRANT SELECT ON mass_balance.web_mass_balance_fix_date_latest TO glporo;
GRANT SELECT ON mass_balance.web_mass_balance_fix_date_latest TO glro;