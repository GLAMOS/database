CREATE OR REPLACE VIEW mass_balance.csv_mass_balance_fix_date_elevation_bins_data AS
	SELECT
...
ALTER TABLE mass_balance.csv_mass_balance_fix_date_elevation_bins_data
    OWNER TO gladmin;

GRANT ALL ON TABLE    mass_balance.csv_mass_balance_fix_date_elevation_bins_data TO gladmin;
GRANT SELECT ON TABLE mass_balance.csv_mass_balance_fix_date_elevation_bins_data TO glporo;
GRANT SELECT ON TABLE mass_balance.csv_mass_balance_fix_date_elevation_bins_data TO glro;