CREATE OR REPLACE VIEW mass_balance.csv_mass_balance_observation_data AS
	SELECT 
...
ALTER TABLE mass_balance.csv_mass_balance_observation_data
    OWNER TO gladmin;

GRANT ALL ON TABLE    mass_balance.csv_mass_balance_observation_data TO gladmin;
GRANT SELECT ON TABLE mass_balance.csv_mass_balance_observation_data TO glporo;
GRANT SELECT ON TABLE mass_balance.csv_mass_balance_observation_data TO glro;