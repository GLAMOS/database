...
CREATE OR REPLACE VIEW mass_balance.web_mass_balance_observation_glacier_json AS
 ...
 FROM (
	...
	jsonb_build_object('year_from', mbo.year_from, 'year_to', mbo.year_to, 'variation', mbo.annual_mass_balance, 'variation_cumulative', mbo.annual_mass_balance_cumulative) AS mass_balance_observation
